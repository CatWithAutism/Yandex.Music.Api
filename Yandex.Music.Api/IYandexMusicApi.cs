...
public interface IYandexMusicApi
{
    ...
    /// <param name="playlistKind">Playlist kind</param>
    /// <returns></returns>
    Task<YInsertTrackToPlaylistResponse> InsertTrackToPlaylistAsync(string trackId, string albumId,
        string playlistKind);
    ...
    /// <returns></returns>
    Task<YDeleteTrackFromPlaylistResponse> DeleteTrackFromPlaylistAsync(int from, int to, int revision,
        string playlistKind);
