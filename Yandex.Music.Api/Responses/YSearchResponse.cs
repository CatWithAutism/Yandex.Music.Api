...
//        public misspell
        ...
        internal static YSearchResponse FromJson(JToken json)
        {
            ...
            return new YSearchResponse
            {
                ...
                {
                    Items = json.SelectToken("albums")?.SelectToken("items")?.Select(YSearchAlbumModel.FromJson)
                        .ToList(),
                ...
                {
                    Items = json.SelectToken("tracks")?.SelectToken("items")?.Select(YSearchTrackModel.FromJson)
                        .ToList(),
                ...
                {
                    Items = json.SelectToken("artists")?.SelectToken("items")?.Select(YSearchArtistModel.FromJson)
                        .ToList(),
                ...
                {
                    Items = json.SelectToken("playlists")?.SelectToken("items")?.Select(YSearchPlaylistModel.FromJson)
                        .ToList(),
